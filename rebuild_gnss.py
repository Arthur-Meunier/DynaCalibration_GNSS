#!/usr/bin/env python3
"""
Script pour nettoyer et reconstruire le fichier page_GNSS.py
"""
...
def clean_and_rebuild():
    """Nettoie et reconstruit le fichier page_GNSS.py"""
    ...
    backup_path = page_gnss_path.with_suffix('.py.backup')
    page_gnss_path.rename(backup_path)
    print(f"✅ Sauvegarde créée: {backup_path}")
    
    # Créer un nouveau fichier propre avec juste la navigation automatique
...
from PyQt5.QtGui import QPainter, QColor, QFont, QPen, QBrush, QRectF
from pathlib import Path
...
'''
    ...
    print("✅ Fichier page_GNSS.py reconstruit avec succès")
    return True
